...
class PostController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        # GET ALL the category IDs of he POST then save it into an array.
        $selected_categories = [];
    ...
    public function update(Request $request, $id)
    {
        ...
        #3. DELETE all records from  category_post table that is related tp this post
       ...
       //createMany() ~~ will insert to the table using array.
