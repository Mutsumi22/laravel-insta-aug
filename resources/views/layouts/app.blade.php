        ...
        <main class="py-5">
            <div class="container">
                ...
                @if (request()->is('admin/*'))
                        <div class="col-3">
                            <ul class="list-group">
                                <a href="{{route('admin.users.index')}}" class="list-group-item {{ (request()->is('admin/users/index') ? 'active' : '' ) }} "> 
                                     <i class="fa-solid fa-user"></i> users
                                </a>
                                <a href="{{route('admin.posts.index')}}" class="list-group-item {{ (request()->is('admin/posts/index') ? 'active' : '' ) }}  "> 
